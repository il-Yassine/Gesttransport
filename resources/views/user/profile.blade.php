...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="fronts/plugins/fontawesome-free/css/all.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="fronts/dist/css/adminlte.min.css">
</head>
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="dashboard/dist/img/user4-128x128.jpg"
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <div class="tab-pane" id="settings" class="card-body">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Nom complet</label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputName" placeholder="Nom complet">
                        </div>
                      </div>
                      <div class="form-group row">
