            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route ('trajets.index') }}">Ajouter un trajet</a>
                        {{-- <a class="collapse-item" href="{{route ('trajets.edit') }}"> Voir un trajet</a> --}}
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Nombre de chauffeur disponible</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                @if($chauffeurs->count()==0)
                                                <h3>0</h3>
                                              @else
                                                <h3>{{$chauffeurs->count()}}</h3>
                                              @endif
                                            </div>
                                        </div>
                                        <div class="col-auto">
